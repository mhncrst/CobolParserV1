...
public class CobolParagraphDeclarationImpl extends ASTWrapperPsiElement implements CobolParagraphDeclaration {

  public CobolParagraphDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitParagraphDeclaration(this);
  }
  ...
  public CobolProcedureName getProcedureName() {
    return findNotNullChildByClass(CobolProcedureName.class);
  }
