...
public class CobolPerformStatementImpl extends ASTWrapperPsiElement implements CobolPerformStatement {
  ...
  @Override
  @NotNull
  public CobolPerformUntilPhrase getPerformUntilPhrase() {
    return findNotNullChildByClass(CobolPerformUntilPhrase.class);
  }

  @Override
  @NotNull
  public CobolPerformVaryingPhrase getPerformVaryingPhrase() {
    return findNotNullChildByClass(CobolPerformVaryingPhrase.class);
  }
